<%@ Page Title="" Language="C#" MasterPageFile="~/mail/MailMaster.Master" AutoEventWireup="true" CodeBehind="Compose_Mail.aspx.cs" Inherits="ELearning.mail.Compose_Mail" %>
        ...
        <div class="auto-style2">
            ...
            <table class="auto-style4">
                ...
                <tr>
                    <td class="auto-style5">&nbsp;</td>
                    <td colspan="2">
                        <asp:TextBox ID="TxtToId" runat="server" Width="500px" AutoPostBack="True" OnTextChanged="TxtToId_TextChanged"></asp:TextBox>
                        <br />
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="LblMsg" runat="server" Font-Bold="True" Font-Italic="False" Font-Size="Large" ForeColor="Red" Text="This is not a Registred Mail Id" Visible="False" Width="500px"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="TxtToId" EventName="TextChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <td>&nbsp;</td>
