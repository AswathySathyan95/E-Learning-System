            ...
            <tr>
                <td class="auto-style15">
                    ...
                    <asp:Timer ID="Timer2" runat="server" OnTick="Timer1_Tick" Interval="1000">
                        ...
                        <br />
                        <br />
                        &nbsp <asp:Label ID="LblQstnNo" runat="server" Font-Bold="True" Font-Size="Medium" Text="1"></asp:Label>
&nbsp;
                    ...
                    <div id="a">
                        <br />
                         &nbsp <asp:RadioButton ID="RbAOptn" runat="server" GroupName="optn" OnCheckedChanged="RbAOptn_CheckedChanged" />
                    </div>
                    <div id="b">
                        <br />
                       &nbsp <asp:RadioButton ID="RbBOptn" runat="server" GroupName="optn" OnCheckedChanged="RbBOptn_CheckedChanged" />
                    </div>
                    <div id="c">
                        <br />
                        &nbsp <asp:RadioButton ID="RbCOptn" runat="server" GroupName="optn" OnCheckedChanged="RbCOptn_CheckedChanged" />
                    </div>
                    <div id="d">
                        <br />
                ...
                <td>
                    ...
                    <div id="qstnboard" class="auto-style12">
                        ...
                        <asp:Button ID="BtnSubmit" runat="server" BackColor="#999999" Font-Bold="True" Font-Size="X-Large" ForeColor="Black" OnClick="BtnSubmit_Click" Text="Finish Test" Height="50px" />
                    </div>
                    </div>
                    &nbsp;</td>
            </tr>
