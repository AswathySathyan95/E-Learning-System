 ...
 <div id="accordion" class="auto-style2">
  ...
  <div class="card">
    ...
    <div id="collapseOne">
      ...
      <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" Collapsed="True" CollapseControlID="Label20" ExpandControlID="Label20" TargetControlID="PanelPersonal" />
  </div>  
  <div class="card">
