        ...
        <table class="w-100">
            ...
            <tr>
                ...
                <td colspan="2" rowspan="6">
                            <asp:GridView ID="GvQuestions" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Height="236px" Width="986px" AllowPaging="true" OnPageIndexChanging="GvQuestions_PageIndexChanging" PageSize="5" OnRowCommand="GvQuestions_RowCommand" OnSelectedIndexChanged="GvQuestions_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btn_deleteQstn" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" CommandArgument='<%# Eval("Q_Id") %>' CommandName="deleteQuestion">
