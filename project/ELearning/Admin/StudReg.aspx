<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeBehind="StudReg.aspx.cs" Inherits="ELearning.Admin.StudReg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    <div id="accordion" class="auto-style2">
        <div>
            ...
            <table class="w-100">
                <tr>
                    <td class="text-center" colspan="2">&nbsp;<span class="newStyle1">&nbsp;Student Registration</span></td>
                </tr>
                <tr>
        ...
        <asp:Panel ID="PanelPersonal" runat="server" SuppressPostBack="true" Width="1093px">
            <table class="auto-style39">
                    ...
                    <td colspan="5">
                        <table class="w-100">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtfname" runat="server" CssClass="auto-style46" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlBloodgroup" runat="server" Width="200px">
                            <asp:ListItem>---Select---</asp:ListItem>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="BtnUploadd" runat="server" OnClick="btnUploadd_Click" Text="Upload" Width="150px" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        ...
        <asp:Panel ID="PanelAddress" runat="server" SuppressPostBack="true" Width="1043px">
            <table class="w-100">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlState" runat="server" AutoPostBack="True" CssClass="auto-style40" OnSelectedIndexChanged="ddlState_SelectedIndexChanged" Width="250px">
                            <asp:ListItem>---Select---</asp:ListItem>
                    ...
                    <td>
                        <asp:TextBox ID="txtPin" runat="server" Width="250px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
        ...
        <asp:Panel ID="PanelAdmission" runat="server" SuppressPostBack="true" Height="122px" Width="1045px">
                <table class="w-100">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDoa" runat="server" TextMode="Date" Width="200px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label23" runat="server" Text="Admitted Program"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlProgram" runat="server" OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged" style="margin-bottom: 0" Width="200px">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlDept" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged1">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Label ID="Label24" runat="server" CssClass="auto-style1" ForeColor="Black" Text="Admitted Branch"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAdmsnNo" runat="server" Width="200px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <asp:Panel ID="PanelGuardian" runat="server" SuppressPostBack="true" Width="1051px">
            <table class="w-100">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFathername" runat="server" Width="250px"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="Label28" runat="server" Text="Mobile No"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtFMob" runat="server" Width="250px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtOccupation" runat="server" style="margin-bottom: 4" Width="250px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
